...
if (isset($_POST['AdmissionNo']) ) {
	...
	/*header("Location:http://www.zebaki.co.ke/Waondo/pages/individualFee.php?AdmissionNo=$AdmissionNo");*/
	echo "<script>window.location='http://www.zebaki.co.ke/Waondo/pages/individualFee.php?AdmissionNo=$AdmissionNo';</script>";
...
function validateForm() {
    ...
    if (x == "") {
        alert("Kindly fill the Admission Number on the form");
        return false;
    }
}
</script>
