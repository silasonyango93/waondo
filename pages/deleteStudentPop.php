...
echo "<script>if (confirm('You are about to remove $StudentName from the system')) {
    window.location='http://www.zebaki.co.ke/Waondo/pages/deleteStudent.php?AdmissionNo=$AdmissionNo';
} else {
