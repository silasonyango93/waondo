...
// echo json_encode($response);
 mysqli_query($con,$query) or die("The Admission Number does not exist.");
						...
						echo "Fee paid succesfully";
                           ...
                           echo "<script>window.location='https://www.zebaki.co.ke/Waondo/pages/receipt.php?AdmissionNo=$AdmissionNo&AmountPaid=$AmountPaid';</script>";
                        }
...
// echo json_encode($response);
 ...
 function deleteInstallments($con,$AdmissionNo,$s)
 {
   ...
   $sql = "DELETE FROM `installments` WHERE `installments`.`AdmissionNo` = $AdmissionNo AND InstallmentDate LIKE '%$s%'";  
     ...
     echo "<script>window.location='https://www.zebaki.co.ke/Waondo/pages/individualFee.php?AdmissionNo=$AdmissionNo';</script>";
...
// echo json_encode($response);
 mysqli_query($con,$query) or die("The Admission Number does not exist.");
						...
						echo "Deletion made succesfully";
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Enter Admission Number of student you would like to delete the fee entry from</h3>
                    </div>
