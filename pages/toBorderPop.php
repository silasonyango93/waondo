...
echo "<script>if (confirm('Are you sure you want to change $StudentName\'s residence from Day Scholar to Border?')) {
    window.location='http://www.zebaki.co.ke/Waondo/pages/toBorder.php?AdmissionNo=$AdmissionNo';
} else {
