...
// echo json_encode($response);
 ...
 $query1="INSERT INTO `fee` (`AdmissionNo`,`LunchScheme`,`PE`,`EW`,`LT`,`RMI`,`Administration`,`Activity`,`Total`,`RecentPaidDate`,`TermBalance`,`AnnualBalance`) VALUES ('$AdmissionNo',0,0,0,0,0,0,0,0,'$d',16000,32150);"; 
 mysqli_query($con,$query1) or die(mysqli_error($con));
 echo "Student Registered Successfully";}
 
 else if($StudentType=="Border" && $TermName=="TERM 2"){
 $query1="INSERT INTO `fee` (`AdmissionNo`,`LunchScheme`,`PE`,`EW`,`LT`,`RMI`,`Administration`,`Activity`,`Total`,`RecentPaidDate`,`TermBalance`,`AnnualBalance`) VALUES ('$AdmissionNo',0,0,0,0,0,0,0,0,'$d',9720,32150);"; 
 mysqli_query($con,$query1) or die(mysqli_error($con));
 echo "Student Registered Successfully";}
 
 else if($StudentType=="Border" && $TermName=="TERM 3"){
 $query1="INSERT INTO `fee` (`AdmissionNo`,`LunchScheme`,`PE`,`EW`,`LT`,`RMI`,`Administration`,`Activity`,`Total`,`RecentPaidDate`,`TermBalance`,`AnnualBalance`) VALUES ('$AdmissionNo',0,0,0,0,0,0,0,0,'$d',6430,32150);";  
 mysqli_query($con,$query1) or die(mysqli_error($con));
 echo "Student Registered Successfully";}
