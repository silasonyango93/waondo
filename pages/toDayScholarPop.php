...
echo "<script>if (confirm('Are you sure you want to change $StudentName\'s residence from Border to Day Scholar?')) {
    window.location='http://www.zebaki.co.ke/Waondo/pages/toDayScholar.php?AdmissionNo=$AdmissionNo';
} else {
