...
$sql = "select * from students WHERE `students`.`AdmissionNo` = $AdmissionNo";
 ...
 if($StudentType=="Day Scholar")
 {
     ...
     echo "<script>window.location='http://www.zebaki.co.ke/Waondo/pages/displayFee.php?AdmissionNo=$AdmissionNo';</script>";
 }
 else{
 ...
 mysqli_query($con,$query) or die("The Admission Number does not exist.");
                            ...
                            echo "<script>window.location='http://www.zebaki.co.ke/Waondo/pages/changedInvoice.php?AdmissionNo=$AdmissionNo';</script>";
