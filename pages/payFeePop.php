...
echo "<script>if (confirm('Pay $AmountPaid for $StudentName?')) {
    window.location='http://www.zebaki.co.ke/Waondo/pages/updateFee.php?AdmissionNo=$AdmissionNo&AmountPaid=$AmountPaid';
} else {
