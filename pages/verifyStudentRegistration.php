...
<body>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Class List for Form <?php echo $Class;?>
                        </div>
                        <!-- /.panel-heading -->
 ...
 $sql = "select * from students INNER JOIN fee ON students.AdmissionNo=fee.AdmissionNo WHERE students.ClassId=$ClassId;";
...
<tr class="gradeA">
		...
		echo "No registered students for this class yet.";
	}
	...
	//echo json_encode(array("result"=>$temp_array));
            ...
            <a href="https://www.zebaki.co.ke/Waondo/pages/verifyStudentRegistrationPop.php">Go Back</a>
        </div>
        <!-- /#page-wrapper -->
